...
namespace LeafEmu.World.Game.Quest
{
    public class QuestAction
    {
        ...
        private String cond { get; }
        private Map.Map map { get; }

        public QuestAction(int id, String args, String cond, Map.Map map)
        {
            this.id = (id);
            this.args = (args);
            this.cond = (cond);
        ...
        public static Dictionary<int, int[]> getDopeul()
        {
            Dictionary<int, int[]> changeDopeul = new Dictionary<int, int[]>();
            changeDopeul.Add(1549, Couple(167, 460)); // Dopeul iop
            changeDopeul.Add(1466, Couple(169, 465)); // Dopeul sadida
            changeDopeul.Add(1558, Couple(168, 458)); // Dopeul cra
            changeDopeul.Add(1470, Couple(162, 464)); // Dopeul enu
            changeDopeul.Add(1469, Couple(164, 468)); // Dopeul xelor
            changeDopeul.Add(1546, Couple(161, 461)); // Dopeul osa
            changeDopeul.Add(1554, Couple(160, 469)); // Dopeul feca
            changeDopeul.Add(6928, Couple(166, 462)); // Dopeul eni
            changeDopeul.Add(8490, Couple(2691, 466)); // Dopeul panda
            changeDopeul.Add(6926, Couple(163, 467)); // Dopeul sram
            changeDopeul.Add(1544, Couple(165, 459)); // Dopeul eca
            changeDopeul.Add(6949, Couple(455, 463)); // Dopeul sacri
            return changeDopeul;
        }

        private static int[] Couple(int i, int j)
        {
            return new int[] { i, j };
        }

        public bool apply(Network.listenClient prmClient, Entity.Entity target, int itemID, int cellid)
        { return false; }
        ...
        //    {
        //        prmClient.SendMessageToPlayer("<b>Action impossible,</b> vous êtes en combat !");
        //        return true;
        //    }
        //    if (!cond.Equals(string.Empty) && !cond.Equals("-1") && !ConditionParser.validConditions(player, cond))
        //    {
        //        prmClient.GAME_SEND_Im_PACKET("119");
        //        return true;
        //    }
        ...
        //            //if (player.Inventaire.getItemByPos(Constant.ITEM_POS_PNJ_SUIVEUR) != null)
        //            //{
        //            //    int skinFollower = player.Inventaire.getItemByPos(Constant.ITEM_POS_PNJ_SUIVEUR).Template.ID;
        //            //    if (Constant.getQuestByMobSkin(skinFollower) != -1)
        //            //    {
        ...
        //            player.teleport(prmClient, Constant.getStartMap(player.classe), Constant.getStartCell(player.classe));
        //            break;
        //        case -10: //Alignement ange si plus de demon et vice-versa sinon random
        //            if (player.align == 1 || player.align == 2
        //                    || player.align == 3)
        //                return true;
        //            break;
        ...
        //                    }
        //                }
        //                SocketManager.GAME_SEND_ECK_PACKET(player.getGameClient(), 5, string.Empty);
        ...
        //            if (player.getLevel() <= 30 || Main.serverId != 1)
        //            {
        //                try
        //                {
        ...
        //            if (player.getLevel() <= 30 || Main.serverId == 38)
        //            {
        ...
        //                // id,lvl|id,lvl:mapid
        //            String ValidMobGroup = string.Empty;
        ...
        //                newObj.addTxtStat(Constant.STATS_ALIGNEMENT_TRAQUE, Integer.toHexString(tempP.get_align()) + string.Empty);
        //                newObj.addTxtStat(Constant.STATS_GRADE_TRAQUE, Integer.toHexString(tempP.getALvl()) + string.Empty);
        //                newObj.addTxtStat(Constant.STATS_NIVEAU_TRAQUE, Integer.toHexString(tempP.getLevel()) + string.Empty);
        ...
        //            String ValidMobGroup1 = string.Empty;
        //            if (player.getFight() != null)
        //                return true;
        //            try
        //            {
        ...
        //            SocketManager.GAME_SEND_GA_PACKET(player.getGameClient(), string.Empty, "2", player.getId()
        //                    + string.Empty, "6");
        ...
        //                        + cellid
        //                        + ","
        //                        + Animation.PrepareToGA(animation), string.Empty);
        //            }
        //            catch (Exception e)
        //            {
        //                e.printStackTrace();
        ...
        //            if (player.getFight() != null)
        //                return true;
        //            String ValidMobGroup2 = string.Empty;
        ...
        //                        if (key1 && key2)
        //                        {
        //                            String replace1 = Integer.toHexString(8342), replace2 = Integer.toHexString(8343), newStats = string.Empty;
        ...
        //                if (key0)
        //                {
        //                    String replace = Integer.toHexString(8073), newStats = string.Empty;
        //                    for (String i : stats.split(","))
        //                        if (!i.equals(replace))
        //                            newStats += (newStats.isEmpty() ? i : "," + i);
        //                    player.getItemTemplate(10207).getTxtStat().remove(Constant.STATS_NAME_DJ);
